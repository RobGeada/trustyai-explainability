...
@Path("/metrics/ood")
public class OutOfDistributionEndpoint implements MetricsEndpoint {

    private static final Logger LOG = Logger.getLogger(OutOfDistributionEndpoint.class);
    @Inject
    ...
    public Response ood(@ValidBaseMetricRequest BaseMetricRequest rawRequest) throws DataframeCreateException {
    ...
    public Response getDefinition() {
        return Response.ok("Out of Distribution todo").build();
    }
    ...
    public Response createRequest(@ValidBaseMetricRequest BaseMetricRequest request) {
        ...
        scheduler.registerOod(id, reconciledMetricRequest);
